...
digestion = HealthIssue.new name: "Digestion, Stomach"
File.open( path('stomach'), 'rb') {|file| digestion.photo = file }
digestion.save

# , photo: upload_image('stomach')
# heart = HealthIssue.create name: "High Blood Pressure", photo: upload_image('heart')
# eyes = HealthIssue.create name: "Eyes", photo: upload_image('eye')
# bones = HealthIssue.create name: "Bones", photo: upload_image('joint')
# joints = HealthIssue.create name: "Joints", photo: upload_image('joint')
# teeth = HealthIssue.create name: "Teeth, Gums", photo: upload_image('tooth')
# blood = HealthIssue.create name: "Diabetes", photo: upload_image('bloodvessel')
# weight = HealthIssue.create name: "Weight Loss, Detox", photo: upload_image('weight')
# respiratory = HealthIssue.create name: "Respiratory System", photo: upload_image('lungs')
# inflammation = HealthIssue.create name: "Inflammation", photo: upload_image('inflammation')
# immunization = HealthIssue.create name: "Immunize", photo: upload_image('immune')
